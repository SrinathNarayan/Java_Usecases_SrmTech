...
public class FileHeaderDetails {
    ...
    public FileHeaderDetails(Date dateTime, String manufacturerName, int numberofRecords, String fileSequence,
            int total) {
    ...
    public String toString() {
        return "FileHeaderDetails [dateTime=" + dateTime + ", fileSequence=" + fileSequence + ", manufacturerName="
